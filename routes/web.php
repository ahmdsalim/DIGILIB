...
Route::middleware('guest')->group(function() {
	...
	Route::post('register/verify/resend', [App\Http\Controllers\Auth\RegisterController::class, 'resendEmail'])->middleware('throttle:2,1')->name('register.verify.resend');
	...
	Route::get('auth/aktivasi-akun', [UserController::class, 'aktivasi'])->name('users.aktivasi');
	Route::get('auth/login-action', [App\Http\Controllers\Auth\RegisterController::class, 'login_action'])->name('login.action');
});	
