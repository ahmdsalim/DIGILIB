                                    ...
                                    <div class="btn-group">
                                        ...
                                        <div class="btn-group dropdown">
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-end">
                                                ...
                                                <li><a class="dropdown-item" href="{{ route('siswa.export') }}">Excel</a></li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <tbody>
                                            @forelse($siswas as $siswa)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div
                                                            class="badge {{ isset($siswa->user) && $siswa->user->active ? 'bg-success' : 'bg-danger' }}">
                                                            {{ isset($siswa->user) && $siswa->user->active ? 'User (' . $siswa->user->email . ')' : 'Non-user' }}
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <div class="text-nowrap text-center">
                                                            <a href="{{ route('sekolah.siswa.edit', $siswa->nisn) }}"
                                                            ...
                                                            <form class="d-inline-block"
                                                                action="{{ route('sekolah.siswa.destroy', $siswa->nisn) }}"
                                                                method="POST">
                                                                @method('delete')
                                                                @csrf
                                                                <button type="button"
