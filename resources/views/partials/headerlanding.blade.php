         ...
         <div class="header__content-start">
            ...
            <div class="header-searchbox">
               ...
               <i class="demo-psi-magnifi-glass"></i>
                  ...
                  @if(request()->route()->getName() != 'book.search' && request()->route()->getName() != 'pembaca.profile' && request()->route()->getName() != 'pembaca.changepassword.show' && request()->route()->getName() != 'koleksi' && request()->route()->getName() != 'buku.detailbuku' && request()->route()->getName() != 'terakhirdibaca')                 
