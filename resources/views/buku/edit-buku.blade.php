                            ...
                            <div class="card-body">
                                ...
                                <form class="row g-3" action="{{ route('buku.update') }}" method="post"
                                    ...
                                    <div class="col-12">
                                        ...
                                        <input id="_dm-inputAddress" name="jumlah_halaman" type="number"
                                            onkeydown="preventNegativeInput(event)" class="form-control"
                                            placeholder="Masukan Jumlah Halaman">
                                    </div>
                                    <div class="col-12">
                                        <label for="_dm-inputAddress" class="form-label">URL PDF</label>
                                        <input id="_dm-inputAddress" name="url_pdf" type="number"
                                            onkeydown="preventNegativeInput(event)" class="form-control"
                                            placeholder="Masukan URL PDF">
                                    </div>
                                    <div class="row mt-3 ">
