                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="text-nowrap text-center">
                                                            <a href="{{ route('kategori.edit',$kategori->id) }}" class="btn btn-icon btn-sm btn-light"><svg
                                                            ...
                                                            <a href="" class="btn btn-icon btn-sm btn-light dlt-kategori"
                                                                data-id="{{ $kategori->id }}"
                                                                data-name="{{ $kategori->kategori }}"><svg fill="none"
            ...
            $('.dlt-kategori').click(function() {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        window.location = "/kategori/" + idkategori + ""
                        Swal.fire(
                            'Deleted!',
