                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="text-nowrap text-center">
                                                        <a href="{{route('owner.guru.edit',$guru->id)}}" class="btn btn-icon btn-sm btn-light"><svg
                                                        ...
                                                        <form class="d-inline-block" action="{{route('owner.guru.destroy',$guru->id)}}" method="POST">
                                                        @method('delete')
                                                        @csrf    
