...
@section('breadcrumb')
    <ol class="breadcrumb mb-0">
        ...
        <li class="breadcrumb-item active" aria-current="page"><a href="{{ route('owner.users.index') }}">User</a></li>
    </ol>
@endsection
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="text-nowrap text-center">
                                                        <a href="{{route('owner.users.show',$user->id)}}" class="btn btn-icon btn-sm btn-light"><svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 256 256">
                                                        ...
                                                        <a href="{{route('owner.users.edit',$user->id)}}" class="btn btn-icon btn-sm btn-light"><svg
                                                        ...
                                                        <form class="d-inline-block" action="{{route('owner.users.destroy',$user->id)}}" method="POST">
                                                        @method('delete')
                                                        @csrf    
